fetch('https://api.openweathermap.org/data/2.5/onecall?lat=50.45&lon=30.52&exclude=current,minutely,hourly,alerts&appid=8f60b14c264b0593e50ea3f05717d2ee')
...
function renderKyiv(data){
    document.querySelector('.H2').textContent = data.timezone;
